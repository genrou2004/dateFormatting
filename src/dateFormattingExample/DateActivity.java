...
public class DateActivity
{
	public static void main(String args[])
	{
		...
		GregorianCalendar gc1 = new GregorianCalendar(2010,2,15,15,30,0);
		System.out.print("Time: ");
		System.out.print(gc1.get(Calendar.HOUR)+":");
		System.out.print(gc1.get(Calendar.MINUTE) + ":");
